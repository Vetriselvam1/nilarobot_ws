#include "nilarobot_controller/simple_controller.hpp"
                                  ...
                                  , theta_(0.0)
{
    ...
    vel_sub_ = create_subscription<geometry_msgs::msg::TwistStamped>("/nilarobot_controller/cmd_vel", 10, std::bind(&SimpleController::velCallback, this, _1));
    ...
    odom_pub_ = create_publisher<nav_msgs::msg::Odometry>("/nilarobot_controller/odom", 10);
...
void SimpleController::velCallback(const geometry_msgs::msg::TwistStamped &msg)
{
    ...
    Eigen::Vector2d nilarobot_speed(msg.twist.linear.x, msg.twist.angular.z);
    Eigen::Vector2d wheel_speed = speed_conversion_.inverse() * nilarobot_speed;
...
void SimpleController::jointCallback(const sensor_msgs::msg::JointState &state)
{
    ...
    // then calculates the velocity of the nilarobot wrt the nilarobot frame
