...
void loop() {
  right_wheel_meas_vel = (10 * right_encoder_counter * (60.0/385.0)) * 0.10472;  //velacity
  String encoder_read = "r" + right_encoder_sign + String(right_wheel_meas_vel); // taking rpm value radian per second
...
void rightEncoderCallback()
{
  ...
  {
    right_encoder_sign = "p";  ///clock wise
  }
  else
  {
    right_encoder_sign = "n";  //anti clockwise
  }
